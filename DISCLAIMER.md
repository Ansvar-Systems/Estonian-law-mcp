...
- **No Attorney-Client Relationship**: Use of this Tool does not create an attorney-client relationship (esindussuhe / advokaadi-kliendi suhe)
...
If you are a lawyer (vandeadvokaat / advokaat), legal researcher, or other legal professional:

- **Malpractice Risk**: Relying on unverified information from this Tool in professional legal work may constitute professional malpractice (kutsealane hooletus)
...
- **Professional Rules**: Members of the Estonian Bar Association (Eesti Advokatuur) must comply with applicable professional conduct rules (advokaadi eetikakoodeks) when using AI tools
...
1. Checking the official source (riigiteataja.ee — Riigi Teataja, the official State Gazette)
2. Verifying the provision is currently in force (kehtiv) and has not been amended (muudetud) or repealed (kehtetuks tunnistatud)
3. Reading the full context of cited provisions
4. Consulting case law (kohtupraktika) and explanatory materials (seletuskirjad, eelnõu materjalid) for interpretation
...
This Tool aggregates data from official Estonian legal databases. However:

| Source Type | Authority Level | Use Case |
|------------|----------------|----------|
| **riigiteataja.ee** | Authoritative | Statute text, consolidated legislation (primary reference) |
...
### Digital-First Legal System

Estonia's Riigi Teataja (riigiteataja.ee) is the sole official source of Estonian legislation and publishes legally binding consolidated texts in digital form. When in doubt:

- The current consolidated text on riigiteataja.ee is the authoritative version
- Historical versions (ajaloolised redaktsioonid) are available on the platform but must be checked for applicability dates

### Commercial Legal Databases

For professional legal work, **always cross-check with commercial legal databases** such as:

- Riigi Teataja (riigiteataja.ee — official, free), Juura (juura.ee), JURIDICA

These services provide editorial oversight, annotations (kommentaarid), and professional-grade currency guarantees that this Tool **cannot** provide.
...
- Estonian law changes continuously through new acts (seadused), amendments (muudatused), and court decisions (kohtulahendid)
...
- Even "fresh" data may be outdated if recent amendments were published in the Riigi Teataja
- Staleness warnings do not guarantee completeness or accuracy
- Always check official sources for the current legal position (kehtiv õiguslik olukord)

### Amendments and Repeals

- A provision marked "in force" may have been:
  - Amended (muudetud) after the last database update
  - Repealed (kehtetuks tunnistatud) but not yet removed from the database
  - Subject to transitional provisions (üleminekusätted) affecting its applicability
...
1. **Complete case law** — Coverage of Riigikohus (Supreme Court), ringkonnakohtud (circuit courts), and maakohtud (county courts) is limited; do not rely solely on this for case law research (kohtupraktika uuring)
2. **Historical statute versions** — Limited availability of historical provision wording beyond what riigiteataja.ee exposes
3. **Legal commentary** — No editorial annotations (kommentaarid), academic commentary (õigusteadus), or practice guides
4. **Unpublished decisions** — Lower court decisions and administrative decisions (haldusaktid) largely absent
5. **Full legislative history** — Limited coverage of parliamentary materials (Riigikogu stenogrammid, eelnõud, seletuskirjad)
...
- **Context Missing**: Without commentary (kommentaar) and legislative materials, interpretation may be incorrect
...
- This includes but is not limited to:
  - Professional malpractice claims (kutsealase hooletuse nõuded)
  - Lost cases or adverse judgments
  - Client harm from erroneous advice
  - Regulatory sanctions from bar authorities (distsiplinaarmenetlus)
  - Reputational damage
...
- **Sensitive Matters**: For privileged legal matters (saladuse hoidmise kohustus), consider on-premise deployment

### Competence and Diligence

Using this Tool does not reduce your professional obligations to:

- Exercise independent legal judgment (iseseisev õiguslik hinnang)
- Conduct thorough legal research using authoritative sources
- Stay current with legal developments
- Provide competent representation (hoolikas ja asjatundlik esindamine)

## Recommended Workflow for Professional Use

1. **Initial Research**: Use Tool for preliminary research and hypothesis generation
2. **Official Verification**: Cross-check ALL results with official sources (riigiteataja.ee)
3. **Commercial Databases**: Use professional legal resources (Juura, JURIDICA) for annotated versions
...
6. **Update Check**: Before finalizing legal work, check for recent amendments in Riigi Teataja

## Changes to This Disclaimer

This disclaimer may be updated as the Tool evolves or legal/regulatory requirements change. Check the [GitHub repository](https://github.com/Ansvar-Systems/Estonian-law-mcp) for the current version.

## Questions?

For questions about this disclaimer or the Tool's limitations, please open an issue on GitHub:
https://github.com/Ansvar-Systems/Estonian-law-mcp/issues
...
- **ALWAYS VERIFY** all legal information with official sources (riigiteataja.ee)
...
- **COMPLY** with Eesti Advokatuur professional ethics rules regarding AI tool use and client confidentiality
- **DISCLOSE** to clients if required by professional rules (advokaadi eetikakoodeks)
